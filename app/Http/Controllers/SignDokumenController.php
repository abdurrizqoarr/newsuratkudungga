...
class SignDokumenController extends Controller
{
    ...
    public function handleSignDokumen(Request $request)
    {
        $request->validate([
            ...
            'x_coordinate' => 'required|numeric|min:0',
            'y_coordinate' => 'required|numeric|min:0',
        ]);
        ...
        $payload = [
            ...
            'xAxis'           => $request->input('x_coordinate'),
            'yAxis'           => $request->input('y_coordinate'),
        ];
        ...
        $response = Http::attach(
            ...
            ->post(env('API_TTE') . 'sign/dokumen-with-qr', $payload);
