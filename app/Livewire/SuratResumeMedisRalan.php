...
class SuratResumeMedisRalan extends Component
{
    ...
    public function mount()
    {
        ...
        $this->dataSurat = ResumePasienRalan::join('reg_periksa', 'resume_pasien.no_rawat', '=', 'reg_periksa.no_rawat')
            ...
            ->when($this->search, function ($query) {
                $query->where(function ($q) {
                    $q->where('pasien.nm_pasien', 'like', "%{$this->search}%")
                        ...
                        ->orWhere('resume_pasien.no_rawat', 'like', "%{$this->search}%")
    ...
    {
        return view('livewire.surat-resume-medis-ralan');
    }
}
