<div class="p-6" x-data="{ show: true }" x-transition.opacity.duration.400ms>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border">
        ...
        <table class="w-full border border-gray-200 rounded-lg overflow-hidden mb-6">
            <tbody class="divide-y divide-gray-200 text-gray-700">
                ...
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Tanggal Registrasi</td>
                    <td class="px-4 py-2">{{ $resume['tgl_registrasi'] }}</td>
                </tr>
                <tr>
        ...
        <table class="w-full border border-gray-200 rounded-lg overflow-hidden mb-6">
            <tbody class="divide-y divide-gray-200 text-gray-700">
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50 w-1/3">Alasan Masuk</td>
                    <td class="px-4 py-2 whitespace-pre-wrap">{{ $resume['alasan'] ?: '-' }}</td>
                </tr>
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Keluhan Utama</td>
                    <td class="px-4 py-2 whitespace-pre-wrap">{{ $resume['keluhan_utama'] ?: '-' }}</td>
                </tr>
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Pemeriksaan Fisik</td>
                    <td class="px-4 py-2 whitespace-pre-wrap">{{ $resume['pemeriksaan_fisik'] ?: '-' }}</td>
                </tr>
                <tr>
        ...
        <!-- Diagnosa -->
        <h2 class="text-lg font-semibold text-emerald-700 mb-4">Diagnosa & Prosedur</h2>
        <table class="w-full border border-gray-200 rounded-lg overflow-hidden mb-6">
            <tbody class="divide-y divide-gray-200 text-gray-700">
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50 w-1/3">Diagnosa Awal</td>
                    <td class="px-4 py-2">{{ $resume['diagnosa_awal'] ?: '-' }}</td>
                </tr>
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Diagnosa Utama</td>
                    <td class="px-4 py-2">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 whitespace-pre-wrap">
                        ...
                        {{ $resume['diagnosa_sekunder2'] ? ', ' . $resume['diagnosa_sekunder2'] : '' }}
                    </td>
                </tr>
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Prosedur Utama</td>
                    <td class="px-4 py-2 whitespace-pre-wrap">{{ $resume['prosedur_utama'] ?: '-' }}</td>
                </tr>
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Tindakan/Operasi</td>
                    <td class="px-4 py-2 whitespace-pre-wrap">{{ $resume['tindakan_dan_operasi'] ?: '-' }}</td>
                </tr>
            </tbody>
        </table>

        <!-- Terapi & Obat -->
        <h2 class="text-lg font-semibold text-emerald-700 mb-4">Terapi & Obat</h2>
        <table class="w-full border border-gray-200 rounded-lg overflow-hidden mb-6">
            <tbody class="divide-y divide-gray-200 text-gray-700">
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50 w-1/3">Obat di RS</td>
                    <td class="px-4 py-2 whitespace-pre-wrap">{{ $resume['obat_di_rs'] ?: '-' }}</td>
                </tr>
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Obat Pulang</td>
        ...
        <table class="w-full border border-gray-200 rounded-lg overflow-hidden mb-6">
            <tbody class="divide-y divide-gray-200 text-gray-700">
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50 w-1/3">Cara Keluar</td>
                    <td class="px-4 py-2">{{ $resume['cara_keluar'] ?: '-' }}</td>
                </tr>
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Keadaan</td>
                    <td class="px-4 py-2">{{ $resume['keadaan'] ?: '-' }}</td>
                </tr>
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Dilanjutkan</td>
                    <td class="px-4 py-2">{{ $resume['dilanjutkan'] ?: '-' }}</td>
                </tr>
                <tr>
                    <td class="px-4 py-2 font-medium bg-gray-50">Kontrol</td>
                    <td class="px-4 py-2">{{ $resume['kontrol'] ?: '-' }}</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    @if ($isUserLoggedIn)
        <div class="mt-8 bg-white rounded-xl shadow-md p-6 border">
            ...
            <form wire:submit.prevent="signResumeRanap" class="space-y-4" autocomplete="off">
                <!-- NIK -->
                <div>
    ...
    @if ($signedFile)
        <div class="mt-8 bg-white rounded-xl shadow-md p-6 border">
            ...
            <p class="text-gray-700 mb-4">Dokumen resume rawat inap telah ditandatangani secara digital.</p>
